...
import 'package:shishu_sanskar/module/auth/view/select_languages_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Widget getStepText(int step) {
      switch (step) {
                        ...
                        builder: (context, state) {
                          ...
                          return NumberScreen(
                            onTap: () async {
                              ...
                              final wpNumber = wpNumberController.text.trim();
                              if (number.isEmpty) {
                                customErrorToast(
                                  context,
        ...
        case 2:
          return BlocBuilder<LanguagesRadioCubit, int>(
